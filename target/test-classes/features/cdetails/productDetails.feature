Feature: Product Details and Cart Functionality
  ...
  Scenario: Validate product details
    Given user is on the product page for "K9-BD-01"
    Then product title should be "Female Puppy Bulldog"
    ...
    Then check if user is directed to cart page "https://petstore.octoperf.com/actions/Cart.action?addItemToCart=&workingItemId=EST-7"

...
public class SearchPage {
	...
	private By searchResults = By.xpath("//table//a[contains(@href, 'Catalog.action?viewProduct=')]");
	private By productItemResult = By.xpath("//table//a[contains(@href, 'Catalog.action?viewItem=')]");
	private By priceOfProduct = By.xpath("//*[@id=\'Catalog\']/table/tbody/tr[6]/td");
	private By nameOfProduct = By.xpath("//*[@id=\'Catalog\']/table/tbody/tr[3]/td");
	...
	public void typeSearchBox(String animal) throws InterruptedException {
